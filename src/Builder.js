...
function App(props) {
  ...
  const handleMobileScroll = () => {
    // Get the Selection controls
    const selectionLeftControl = document.querySelector(
      ".selection_component_wrap_left"
    );
    const selectionLeftRight = document.querySelector(
      ".selection_component_wrap_right"
    );
    let sliderPosition = document.querySelector(".selection_component_wrap");
    if (sliderPosition.scrollLeft < sliderPosition.clientWidth / 2) {
      selectionLeftControl.style.visibility = "hidden";
      selectionLeftRight.style.visibility = "visible";
    } else {
      selectionLeftControl.style.visibility = "visible";
      selectionLeftRight.style.visibility = "hidden";
    }
  };
  ...
  return (
    <div className="wrap">
      ...
      <div className="builder">
        <div className="selection selection__mobile">
          ...
          <div
            className="selection_component_wrap"
            onScroll={handleMobileScroll}
          >
            {/* Mobile controls selection x2 */}
            <div className="selection_component_wrap_left"></div>
            <div className="selection_component_wrap_right"></div>
            {/* The item list */}
            {items.map((item) => (
              <Selection
                key={item.id}
        ...
        <div className="pizza pizza__mobile">
        ...
        <div className="total total__mobile">
          {/* Switch modes */}
          <div
            className="items__cart_expand-btn"
            onClick={mobileTotalExpand}
          ></div>
